...
const base = {
  ...
  office: {
    ...
    faqs: [
      ...
      { q: 'Which are the best office deep cleaning services in Gurgaon?', a: 'Judge by corporate proof: GST invoicing, staff IDs with verification, NDA readiness, after-hours crews, and hub-tagged references (Cyber City, Udyog Vihar). Our best-office comparison scores the top names head-to-head — read it on our blog before deciding.' },
