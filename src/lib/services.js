...
const base = {
  deep: {
    ...
    faqs: [
      ...
      { q: 'What are the best deep cleaning services in Gurgaon?', a: 'Shortlist by proof, not ads: police verification shown on request, itemised written scope, fixed price before arrival, pay-after walkthrough, and sector-tagged reviews. Whether you compare deep cleaning services Gurgaon providers on price, scope or reviews, the test is the same five proofs — verification, written scope, locked price, pay-after terms and sector-tagged reviews.' },
      ...
      { q: 'How much is a 1 hour clean in Gurgaon?', a: 'We do not sell 1-hour cleans — an hour covers a surface wipe, not deep cleaning, and hourly billing rewards slow work. Honest equivalents: single-room details (₹800–₹1,500), mini-tasks absorbed into any visit, or a house-cleaning visit from ₹499. Fixed scope beats open-ended hours every time.' },
    ],
    reviews: [
  ...
  house: {
    ...
    intro:
      'Our house cleaning services Gurgaon plans — also booked as home cleaning services — keep your Gurgaon home consistently spotless, with [home cleaning services near me](/residential-cleaners-near-me.html) slots same-day. Booked as a single house cleaning service in Gurgaon, each visit follows a written room-by-room checklist at a fixed per-visit price.',
    detail:
      'Life in Gurgaon leaves little time for keeping up with dusting, mopping and tidying — and that is exactly what our house cleaning service is built for. Whether you search home cleaning services, home cleaning services near me or house cleaning services Gurgaon, you land on the same verified team. With construction dust from Dwarka Expressway, Golf Course Extension and [Sohna Road](/blog/sohna-road-deep-cleaning-gurgaon.html) constantly settling, homes need regular maintenance just to stay comfortable. We offer one-time cleans for a fresh start, plus weekly and bi-weekly home cleaning services plans so your home stays consistently clean without you lifting a finger.\n\nEach home cleaning services near me visit includes full dusting and vacuuming, mopping and floor care, kitchen and bathroom surface upkeep, bin emptying and liner change, and sanitization of high-touch surfaces. We work around your schedule in [DLF Phase 1–5](/blog/dlf-phase-1-deep-cleaning-gurgaon.html), Sushant Lok, South City, Palam Vihar, MG Road, Sector 45/46/57 and all Huda sectors. The checklist is tailored to your home size — from compact studio apartments and 1 BHK flats to 3–4 BHK villas.\n\nGurgaon’s hard water and cooking-heavy kitchens mean surface film builds up fast. Regular house cleaning prevents that buildup from becoming a deep-clean problem. Prices start at ₹499 per visit for a studio and scale by size. Every cleaner is police-verified, brings eco-friendly supplies, and you pay only after you walk through and approve the work. Weekly plans get the same trusted team each visit, so they learn your preferences and clean faster over time.\n\nA house cleaning service in Gurgaon is defined by what it is not: not [a maid placement](/blog/house-maid-vs-deep-cleaning-gurgaon.html), not [a one-time deep clean](/deep-cleaning-services-in-gurgaon.html), but a scheduled upkeep visit by a verified two-person team carrying its own HEPA vacuum, microfiber kit, multi-surface mop and eco-friendly sprays — you provide only water and power. Each visit follows the same written checklist, so quality does not depend on who shows up.\n\nVisit scope scales honestly by home size. A studio or 1 RK (₹499, about an hour) covers the single room, kitchenette, bathroom and entrance. A 1 BHK (₹799, 1.5–2 hours) adds the bedroom wardrobe exteriors, living-area detailing and balcony sweep. A 2 BHK (₹1,199, 2–3 hours) doubles bathroom upkeep, adds the second bedroom and dining-area care. A 3 BHK (₹1,699, 3–4 hours) extends to the third bedroom, study corners, utility areas and longer balcony runs. Timings assume normal upkeep condition; first visits after a gap run longer and are quoted upfront.\n\nCadence decides results more than any single visit. Weekly plans suit homes near active construction (Dwarka Expressway, Golf Course Extension, Sohna Road corridors), pet owners and cooking-heavy kitchens — dust and oil mist never get a week to bond. Bi-weekly fits dust-managed towers with working couples out all day. Monthly works only as a supplement between quarterly deep cleans. The math is simple: a ₹1,199 weekly 2 BHK habit (~₹4,800 a month) postpones every ₹4,500 deep clean by months, because limescale, grout dye and baked grease never accumulate to deep-clean grade.\n\nWho books scheduled house cleaning here falls into four groups. Working couples out 10–12 hours who return to a reset home. Seniors who want verified visitors on a fixed weekday rhythm. Landlords running turnover cleans between tenants — same checklist, empty-flat edition, photographed for records. And pet owners, for whom HEPA vacuuming and non-toxic products are the actual product, not a footnote.',
    ...
    includes: ['Full dusting & vacuuming', 'Mopping & floor care', 'Kitchen & bathroom upkeep', 'Bin emptying & liner change', 'Surface wiping & sanitation', 'Bed-making & tidying (optional)', 'HEPA vacuum & microfiber kit included', 'Same team on recurring plans', 'Weekly / bi-weekly / monthly plans', 'Eco-friendly products'],
    process: [
    ...
    faqs: [
      ...
      { q: 'What does a house cleaning service in Gurgaon cover that a maid does not?', a: 'Three things: equipment (HEPA vacuum, microfiber systems, extension dusting a maid typically lacks), a written room-by-room checklist that is identical every visit, and supervision with pay-after-walkthrough terms. A maid keeps daily order; a house cleaning service in Gurgaon resets upkeep-grade buildup on a schedule with verified staff.' },
      { q: 'Which plan suits a 2 BHK working couple — weekly or bi-weekly?', a: 'Weekly if the tower faces construction dust, you cook daily, or anyone has dust allergies — a 2 BHK at ₹1,199 a visit stays ahead of buildup. Bi-weekly works for dust-managed towers where both partners travel frequently. Start bi-weekly; upgrade if bathroom film or dust return before the next visit.' },
      { q: 'Do you bring your own vacuum, mop and products?', a: 'Yes — the team arrives with a HEPA vacuum, microfiber cloths and mops, plus eco-friendly sprays. You provide only water and power access. Products are non-toxic and safe around children and pets, with no harsh chemical smell left behind.' },
      { q: 'How do I pause or reschedule a weekly plan?', a: 'One WhatsApp message before noon reschedules or pauses your slot — travel, guests or festivals included, with no pause fee. The same team resumes on your return, and the checklist picks up exactly where it left off.' },
      { q: 'Can I book a one-time house cleaning service in Gurgaon for a move-out?', a: 'Yes — one-time visits use the same checklist in an empty-flat edition: inside cabinets and wardrobes, balcony and utility detailing, and photo documentation for landlord handover. Tell us it is a move-out on booking so the crew allocates the extra hour.' },
    ],
    reviews: [
  ...
  carpet: {
    ...
    detail:
      'Carpets are dust magnets — especially in Gurgaon, where fine particulate and construction dust settle straight into the pile. Everyday vacuuming only lifts the surface; the deep dirt, pet hair, dust mites and spilled stains stay trapped below, dulling colours and triggering allergies. A carpet that looks “okay” at a glance can hold years of embedded soil that only hot-water extraction removes — our vacuum test on first visits across DLF, Sohna Road and Golf Course Road homes routinely surprises owners.\n\nOur carpet shampoo cleaning uses hot-water extraction to flush out deep-seated dirt and allergens, pre-treats stubborn stains and neutralizes odours, leaving your carpet visibly brighter and fresher. We clean wall-to-wall carpets, area rugs and runners, and assess the fibre — wool, nylon, polyester — before choosing the right treatment. Pricing is by area: from ₹15 per square foot for dry cleaning and ₹18 per square foot for shampoo extraction. A large living-room carpet typically dries within 4–6 hours.\n\nVacuum cleaning services between professional visits keep the surface honest: twice-weekly slow passes (not quick glides) halve the soil load our extraction must lift. Homes with pets or young children should vacuum high-traffic lanes every other day and book extraction every 4–6 months; regularly vacuumed adult-only homes can stretch to 12 months. After renovation dust, flooding or a major spill, book immediately — settled cement and moisture bond fast in Gurgaon’s climate.',
    ...
    faqs: [
      ...
      { q: 'Dry cleaning vs shampoo extraction — which carpet method do I need?', a: 'Dry cleaning (₹15/sq ft) suits lightly soiled carpets, delicate fibres and fastest turnaround — usable almost immediately. Shampoo hot-water extraction (₹18/sq ft) is the real deep clean for embedded dirt, pet stains, odours and allergens. Most Gurgaon homes with construction-dust exposure need extraction at least once a year.' },
      { q: 'Can vacuum cleaning replace professional carpet shampoo?', a: 'No — vacuuming (even twice-weekly) removes only loose surface soil, roughly the top third of what sits in pile. Oils, mite waste, bonded dust and old stains need hot-water extraction. Think of vacuuming as brushing teeth and extraction as the dentist visit.' },
      { q: 'Do you move furniture for wall-to-wall carpet cleaning?', a: 'Light furniture (coffee tables, chairs, floor lamps) is shifted and replaced as part of the job. Heavy items like beds and wardrobes are cleaned around unless you arrange shifting — tell us on the booking call and we plan crew size accordingly.' },
    ],
    reviews: [
  ...
  office: {
    ...
    intro:
      'Office [deep cleaning services](/blog/deep-cleaning-services.html) in Gurgaon for IT parks, startups, clinics, shops and corporate floors — workstations, pantry, washrooms, carpets and glass. After-hours and weekend crews, GST invoice, NDA on request.',
    detail:
      'First impressions matter. The condition of your office — sticky desks, stained carpets, grimy pantry and washrooms — says something about your company before a client says a word. More importantly, shared surfaces are the fastest way for germs to move through a team, and a deep clean every quarter measurably cuts sick days.\n\nOur office deep cleaning service is built around your schedule. We work after hours, early mornings or weekends so your team never has to vacate mid-day. We clean and sanitize workstations (desks, monitors, keyboards, chairs), pantries and kitchens, restrooms, glass partitions, reception and conference rooms, and shampoo carpets or scrub tile floors. Our background-checked staff can sign NDAs if your policy requires it. Pricing depends on floor area and scope — we give you an itemized quote before we start.\n\nOne crew covers every commercial vertical in Gurgaon: IT and BPO floors, coworking spaces, clinics and labs, retail shops and showrooms, restaurants and cafés, salons, schools, showrooms and warehouses. Clinics get disinfection-grade washroom protocols; food outlets get exhaust degreasing and drain care; IT floors get dry anti-static server-zone methods with your IT team in the loop. Shops and clinics under 1,000 sq ft typically run ₹5,000–₹8,000; larger floors quote per square foot after a free site survey.\n\nWe serve every business hub — Cyber City and Cyber Hub, Udyog Vihar Phase 1–5, Golf Course Road and Extension, Sohna Road tech parks, MG Road and DLF Phase 1–5, Sector 32/44/54 corridors, and Manesar/IMT industrial offices. Facility desks get GST invoices with scope lines, staff ID records, chemical MSDS sheets on request and photo-logged walkthrough reports — the documentation audits actually ask for. Serving Gurgaon businesses since 2015.',
    ...
    includes: [
      ...
      'Server & IT zones — dry anti-static dust control, no liquids without IT supervision',
      'Pantry deep degrease — exhaust, appliances, drains and floor traps',
      'Conference & cabins — table polish, glass partitions, chair shampoo on request',
      'Compliance pack — GST invoice, staff IDs, photo-logged walkthrough report',
    ],
    process: [
    ...
    faqs: [
      ...
      { q: 'Do you provide regular office cleaning contracts?', a: 'Yes — we offer weekly, bi-weekly and monthly housekeeping contracts for offices in Gurgaon. WhatsApp +91 9560739281 to discuss a custom contract for your workspace.' },
      { q: 'What is included in an office deep clean?', a: 'Workstations (desks, monitors, keyboards, chairs), pantry degreasing, restroom tile-grout scrub and WC descaling, carpet shampoo or tile scrub, glass partitions and cabins, AC vents and high-dusting, reception and lobby, plus bin sanitising. Server zones get dry anti-static methods only. Every job ends with a supervisor walkthrough and photo log.' },
      { q: 'What is the office deep cleaning price list in Gurgaon?', a: 'Small offices under 1,000 sq ft: ₹5,000–₹8,000. Mid floors (1,000–5,000 sq ft): roughly ₹3–₹11 per sq ft by scope. Monthly housekeeping staff: ~₹14,000–₹18,000 per person per shift. Our quotes itemise everything before arrival — no hidden charges, GST invoice included for facility desks.' },
      { q: 'Which are the best office deep cleaning services in Gurgaon?', a: 'Judge by corporate proof: GST invoicing, staff IDs with verification, NDA readiness, after-hours crews, and hub-tagged references (Cyber City, Udyog Vihar). Our best-office comparison scores the top office deep cleaning services Gurgaon options head-to-head — read it on our blog before deciding.' },
      { q: 'Do you serve Cyber City, Udyog Vihar and Golf Course Road offices?', a: 'Yes — those three plus Sohna Road tech parks, MG Road/DLF Phase 1–5, Sector 32/44/54 corridors and Manesar/IMT industrial offices. After-hours and weekend crews across all hubs at no extra charge.' },
      { q: 'Do you clean clinics, shops and restaurants too?', a: 'Yes — clinics get disinfection-grade washroom and waiting-area protocols; shops/showrooms get glass, floors and trial-area detailing; restaurants get exhaust degreasing and drain care. Each vertical follows its own checklist, priced per sq ft after a free survey.' },
      { q: 'Do you provide GST invoices and documentation for facility audits?', a: 'Yes — GST invoice with scope lines, staff ID and verification records, chemical MSDS sheets on request, and photo-logged walkthrough reports. NDAs signed where your policy requires. Facility desks in Cyber City and Udyog Vihar clear them routinely.' },
    ],
    reviews: [
  ...
  move: {
    ...
    detail:
      'Moving is stressful enough without adding cleaning to the pile. Whether you are a tenant trying to get your full security deposit back or a new owner walking into a space that has seen years of someone else’s use, our move-in / move-out cleaning takes care of every corner.\n\nFor move-outs, we work to landlord checklists so nothing is left to argue about — [kitchen degreased](/kitchen-deep-cleaning-gurgaon.html), [bathrooms descaled](/bathroom-deep-cleaning-gurgaon.html), windows washed, walls spot-cleaned, floors scrubbed and cabinets emptied. For move-ins, we make the space hygienic and ready: sanitizing kitchens and bathrooms, wiping cabinet interiors, cleaning windows and giving the floors a [deep scrub](/deep-cleaning-services-in-gurgaon.html) before your furniture arrives. We cover [apartments and villas across Gurgaon](/residential-cleaners-near-me.html) and can work around your handover date, even same-day in many sectors.',
    image: '/images/full-home-deep-cleaning.webp',
    ...
    faqs: [
      ...
      { q: 'Do you offer same-day move-in cleaning in Gurgaon?', a: 'Yes — same-day slots are available subject to team availability. For move-in cleaning where timing is tight, WhatsApp +91 9560739281 first thing in the morning for the best chance of a same-day slot.' },
  ...
  if (serviceKey === 'fullhome' && bhk) {
    ...
    const BHK_CONTENT = {
      ...
      3: {
        ...
        detail: `The 3 BHK is the family-home sweet spot in Gurgaon — 1,001–1,500 sq ft, 3 bedrooms, 2 or 3 bathrooms, often a small study or store room, a bigger modular kitchen, and either one large or two smaller balconies. Most common in South City 1, Nirvana Country, Sector 50–57, and the [DLF Phase 2–4 belt](/blog/dlf-phase-3-deep-cleaning-gurgaon.html). Three bedrooms means three wardrobes, three AC indoor units, three ceiling fans, and roughly 9 light fixtures that collect dust year-round. That is what the standard "maid cleaning" misses — the study dust, the AC vent dust, and the fan blades that haven't been wiped since the last tenant.\n\nA 3 BHK deep clean takes 9–10 hours with 4 cleaners. AC vent covers are opened and dusted (this is the biggest single difference vs a regular clean). Ceiling fans across all 3 rooms are wiped blade-by-blade. The study gets bookshelf and desk detailing if the room is cleared beforehand. All 2–3 bathrooms get [full descaling](/bathroom-deep-cleaning-gurgaon.html), not just a wipe. The kitchen gets the full [chimney dismantle + filter wash](/blog/kitchen-chimney-cleaning-guide.html) treatment — at this size, kitchens usually have a built-in oven, hob, and chimney, all of which need separate attention. Wardrobe interiors are wiped in all 3 bedrooms. The balcony drain corners are scrubbed. Furnished 3 BHKs (with sofa, dining, study furniture) are ₹6,000–₹6,500; non-furnished ₹5,500 — the figure in our [3 BHK price guide](/blog/3bhk-deep-cleaning-price-gurgaon.html). The price is fixed on the confirmation call.\n\nMost common reasons 3 BHK families book us: [pre-Diwali](/blog/diwali-cleaning-gurgaon.html), post-renovation, before/after a long trip, between tenants in a rented home, or every 4–6 months because family life with kids or pets generates more buildup than weekly cleaning can keep up with.`,
        faqsExtra: [
