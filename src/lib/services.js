...
const base = {
  ...
  office: {
    ...
    process: [
      { step: 1, title: 'Plan', desc: 'Off-hours scheduling to avoid disruption.' },
      { step: 2, title: 'Clean', desc: 'Zones cleaned top-to-bottom.' },
      { step: 3, title: 'Verify', desc: 'Supervisor quality check + your walkthrough.' },
    ],
    faqs: [
