    ...
    <nav className="nav" id="mainNav">
      ...
      <div className="nav-actions">
        <a
          ...
          onClick={() => track('wa_nav', { event_category: 'Lead', event_label: 'Nav WhatsApp' })}
        >
        ...
        <a
          ...
          onClick={() => track('call_nav', { event_category: 'Lead', event_label: 'Nav Call' })}
        >
          ...
          <span className="lbl">+91 92679-05943</span>
        </a>
      </div>
    </nav>
  );
